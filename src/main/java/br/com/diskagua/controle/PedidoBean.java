...
import br.com.diskagua.dao.ClienteDao;
import br.com.diskagua.dao.FuncionarioDao;
import br.com.diskagua.dao.PedidoDao;
import br.com.diskagua.dao.ProdutoDao;
import br.com.diskagua.modelo.Cliente;
import br.com.diskagua.modelo.Email;
import br.com.diskagua.modelo.Funcionario;
import br.com.diskagua.modelo.ItemPedido;
import br.com.diskagua.modelo.Pedido;
import static br.com.diskagua.modelo.Pessoa_.email;
...
public class PedidoBean implements Serializable {
    ...
    public void adicionarProduto(){
        ...
        itemPedido.setTotal(itemPedido.getQuantidade()*itemPedido.getProduto().getPreco());
        int aux=0;
    ...
    public List<Funcionario> getFuncionarios() {
        ...
        return funcionarios = funcionarioDao.listarObjetos();
    }
