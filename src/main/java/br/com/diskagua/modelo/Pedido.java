...
import br.com.diskagua.enumeradores.Status;
...
public class Pedido implements Serializable {
    ...
    public Pedido(Cliente cliente, Date data, Funcionario funcionario, Status status, Double total, List<ItemPedido> itens) {
    ...
    public void enviarEmail(String arquivo, Pedido pedido){
        try {
            ...
            String dataConvertida_BR = converteData(pedido.data);
    ...
    public String visualizar() {
        return "Pedido{" + "codigo=" + codigo + ", cliente=" + cliente + ", data=" + data + ", funcionario=" + funcionario + ", status=" + status + ", total=" + total + ", itens=" + itens() + '}';
    }
